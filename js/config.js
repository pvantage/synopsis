...
function sitemenus()
{
    ...
    menu+='<div id="menu1" class="tab-pane fade"><ul class="cat_links"><li><a href="login.html"><img src="images/accountimage.png"/>Account <span class="setting_right_icon"><img src="images/nextarrow.png"/></span></a></li><li><a href="#"><img src="images/languageimage.png"/>Language<span class="setting_right_icon lang">English<img src="images/nextarrow.png"/></span></a></li><li><a href="#"><img src="images/notificationimage.png"/>Notification<span class="setting_right_icon"><img src="images/notificationsetting.png"/></span></a></li><li><a href="#"><img src="images/6.png"/>HD Image<span class="setting_right_icon"><img src="images/notificationsetting.png"/></span></a></li><li><a href="#"><img src="images/nightmode.png"/>Night Mode<span class="setting_right_icon"><img src="images/notificationsetting.png"/></span></a></li><li><a href="#"><img src="images/inviteimage.png"/>Invite Friends</a></li><li><a href="#"><img src="images/rateimage.png"/>Rate App</a></li><li><a href="feedback.html'+par+'"><img src="images/feedbackimage.png"/>Feedback </a></li><li><a href="instruction.html'+par+'"><img src="images/feedbackimage.png"/>How it works </a></li></ul></div>';
	return menu;
}
